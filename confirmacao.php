...
<body>
         ...
         <li class="nav-item dropdown text-white">
            ...
            <?php endforeach; ?>
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown07">
                  <a class="dropdown-item" href="perfil.php"><font color="#5dbcbc">Perfil</a>
                  <!--Página de gerenciamento do cadastro-->
                  <a class="dropdown-item" href="participacao.php"><font color="#5dbcbc">Participantes</a>
                  <a class="dropdown-item" href="php/logout.php"><font color="#5dbcbc">Sair</a>
                </div>
              </li>
        </ul>
      </div>
  ...
  <section id="barra-cadastro">
    ...
    <h4>Confirmacao de Adocao:</h4>
	   <form name="form" method="POST" action="./php/insere.php" onsubmit="return validacao();">
           ...
           <label>Nome</label>
             <input type="text" class="form-control" name="nome" placeholder="Digite seu nome">
		      ...
		      <div class="form-group col-md-6">
                 <label for="inputState">Dog</label>
                    <select id="inputState" class="form-control" name="dog" placeholder="Digite o nome do dog">
                        <option selected>Felícia</option>
                        <option>Sabrina</option>
                        <option>Simba</option>
                        <option>Ozzy</option>
                        <option>Tunico</option>
                        <option>Bento</option>
                        <option>Bud</option>
                        <option>Kiko</option>
                        <option>Dino</option>
              ...
              <div class="form-group col-md-6">
                 <label for="inputState">Adotar</label>
                    <select id="inputState" class="form-control"  name="adotar">
                        <option selected>Adotar</option>
                        <option>Apadrinhar</option>
                     </select>
              </div>

              <p> Você se compromete, a cuidar e amar esse animal, sem agredi-lo ou abandona-lo, dando segurança e lar para que ele possa viver feliz?</p>
              <div class="form-group form-check">
                 <input type="checkbox" class="form-check-input" id="exampleCheck1">
              <label class="form-check-label" for="exampleCheck1">Sim, confirmo</label>
  </div>

		</div>
					  
       <p align="center">  <button  class="btn btn-dark" type="submit" name="submit"> Adotar</button></p>
	</form>
 </section>
