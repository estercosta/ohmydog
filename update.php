...
<body>
 ...
 <nav id="mainNav" class="navbar navbar-expand-lg fixed-top bg-secundario">
  ...
  <section id="barra-cadastro">
    ...
    <h4>Faça sua Atualização:</h4>
	   <form name="form" method="post" action="php/edite.php?id=<?= $user->id ?>" onsubmit="return validacao();">

		 <div class="form-row">

		    <div class="col-md-6 mb-3">
			     <label>Nome</label>
		         <input type="text" class="form-control" name="nome_nov" placeholder="Digite seu nome" required>
		     </div>

		     <div class="col-md-6 mb-3">
			      <label>Sobrenome</label>
		            <input type="text" class="form-control" name="sobrenome_nov" placeholder="Digite seu sobrenome" required>
		     </div>

		     <div class="col mb-3">
		      	<label>E-mail</label>
			         <input type="email" class="form-control" name="email_nov" placeholder="Digite um email" required>
		     </div>
       </div>
       <div class="form-row">
       <div class="col mb-3">
            <label>Senha</label>
               <input type="password" class="form-control" id="senhaCampo" name="senha_nov" placeholder="Digite uma senha" required>
         </div>
		      <div class="col-md-6 mb-3">
			       <label>Cidade</label>
		            <input type="text" class="form-control" name="cidade_nov" placeholder="Digite sua cidade" required>
		      </div>

		      <div class="form-group col-md-6">
                 <label for="inputState">Estado</label>
                    <select id="inputState" class="form-control" name="estado_nov" placeholder="Digite seu Estado" required>
              ...
              <div class="form-group col-md-6">
                 <label for="inputState">Paticipação</label>
                    <select id="inputState" class="form-control"  name="participacao_nov" required>
       ...
       <p align="center">  <button class="btn btn-dark" id="bot" type="submit" name="submit">Atualizar</button></p>
	</form>
 </section>
